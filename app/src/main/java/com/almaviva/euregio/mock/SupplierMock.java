...
public class SupplierMock {
    ...
    public static ArrayList<Supplier> getListMock() throws ParseException {
        ...
        ArrayList<Agreement> vantaggiArrayList3 = new ArrayList<Agreement>();
        ...
        ArrayList<Agreement> vantaggiArrayList4 = new ArrayList<Agreement>();
        ...
        ArrayList<Agreement> vantaggiArrayList5 = new ArrayList<Agreement>();
